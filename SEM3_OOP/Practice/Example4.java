...
// All classes are named with First character as capital, also anybody could write variable outside class so to avoid and make JAVA 100% OOP. Java dev made int as Integer (class), float as Float (class), double as Double (class), char as Character (class)

// All functions are like parseInt, their 2nd word first letter is capital and first word first letter is small
